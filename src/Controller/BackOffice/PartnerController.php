...
class PartnerController extends AbstractController
{
    ...
    public function new(Request $request, PartnerRepository $partnerRepository, BlobHelper $blobHelper): Response
    {
        $partner = new Partner();
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if ($file) {
                $newFilename = $blobHelper->uploadFile($file, 'partners_directory');
    ...
    public function edit(Request $request, Partner $partner, PartnerRepository $partnerRepository, BlobHelper $blobHelper): Response
    {
        $form = $this->createForm(PartnerType::class, $partner);
        $form->handleRequest($request);
